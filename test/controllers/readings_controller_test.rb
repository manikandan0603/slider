...
class ReadingsControllerTest < ActionController::TestCase
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post :create, reading: { main_slider_values: @reading.main_slider_values, sub_slider_values: @reading.sub_slider_values, user_id: @reading.user_id }
    end
  ...
  test "should update reading" do
    patch :update, id: @reading, reading: { main_slider_values: @reading.main_slider_values, sub_slider_values: @reading.sub_slider_values, user_id: @reading.user_id }
    assert_redirected_to reading_path(assigns(:reading))
  end
